...
`docs/first-incident.md` is the record of the first live run: the answer the runtime produced, the run cycle by cycle, the acceptance criteria checked against it, and the second, third, fourth and fifth runs that measured rounds 2, 3, 4 and 5 beside it.
