 ...
 * (by id), the cycle, whether the verdict dropped the slice (instructions beginning
 * `drop:`), and the unit that took it (`reassignment.taken`), when one has.
 */
...
/** Every reassignment the log records, in order, each with the unit that took it when one has (R4-4). */
 ...
 * verdict, and taken by no unit yet. The planner's section 11 lists them and the
