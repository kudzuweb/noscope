 ...
 * resumed one the sections that changed since the session's last call (R5-11). What the
 * IC reads before any ask.
 */
...
export function commandTurn(
  ...
  return icCall(
    ...
    // resumed one reads what changed since its last call (R5-11).
    (unit) =>
