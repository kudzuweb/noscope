...
Totals, from the event log (`incident review 001` computes the same figures since PR 18, with the planner's per-cycle spend and the cost bounded at list rates):
