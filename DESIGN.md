...
the equipment its tasks may use) and every call is a turn (R5-4: no task runs on the
...
unit's own lines (its objective and the equipment its tasks may use), and, for a unit that took a reassignment (R4-4, `reassignment.taken`
