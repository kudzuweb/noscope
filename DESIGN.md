...
| `noscope incident tree <id>` | The unit tree with each unit's type (R4-10), leader model, last report outcome, the IC's last verdict on it (R4-2), and, for a waiting unit, what it waits on, and task marks: done, running, ready, pending. |
