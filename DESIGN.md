...
Still proposed rather than ruled, and settled by building them: {==the schema==}{>>which schema<<}{id="c66" by="user" at="2026-09-13T03:55:04.866Z"}, {==Opus 5 as the planner model==}{>>this is fine for now<<}{id="c64" by="user" at="2026-09-13T03:54:37.710Z"}, the {==validator rules==}{>>fine for now<<}{id="c65" by="user" at="2026-09-13T03:54:48.468Z"}, t{==he CLI surface==}{>>?<<}{id="c67" by="user" at="2026-09-13T03:55:25.799Z"}, and the first incident. Everything else in this document is a ruling.
## Vocabulary
| Term | Meaning |
|---|---|
